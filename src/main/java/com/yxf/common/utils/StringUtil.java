...
public class StringUtil {
	...
	public static boolean hasText(String src){
		...
		if(src != null && !" ".equalsIgnoreCase(src.trim()) && !"".equalsIgnoreCase(src.trim())) {
			return false;
		}else {
			return true;
		}
	...
	public static String getRandomChar() {
		...
		highCode = (176 + Math.abs(random.nextInt(39)));//B0 + 0~39(16~55)一级汉字
		lowCode = (161 + Math.abs(random.nextInt(93)));//A1 + 0~93每区有94个汉字
	...
	public static String generateChineseName(){
		...
		StringBuffer sb = new StringBuffer();
		StringBuffer name1 = sb.append(src[RandomUtil.random(0, src.length-1)]);
		StringBuffer name2 = sb.append(randomChineseString(2));
